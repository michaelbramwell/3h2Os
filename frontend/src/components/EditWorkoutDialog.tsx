                ...
                <div className="p-4 space-y-4">
                    <div className="space-y-2">
                        ...
                        >
                            ...
                            <option value={ActivityType.RACE}>Race</option>
                            ...
                            {!( [ActivityType.RUN, ActivityType.TRAIL, ActivityType.RACE, ActivityType.CYCLING, ActivityType.SWIMMING] as ActivityType[] ).includes(type as ActivityType) && (
