...
1. [marathon_plan.md](marathon_plan.md): The full 14-week training schedule.
2. [context.md](context.md): The high-level goals, milestones, and current progress.

### Guidelines:
- Always check the current date relative to the plan in [marathon_plan.md](marathon_plan.md).
- If the user asks about "today" or "this week", calculate the current week of the plan based on the "Week Starting" dates.
