...
3. [actuals.json](actuals.json): The log of completed Garmin activities.
...
- **Testing Requirement:** Maintain the `tests/` suite. Any changes to sync or generation logic must be verified with `uv run pytest`.
